...
public class KakaoPayController {
    private String SECRET_KEY="DEV2B572CA6486BFDF267645DCD1613F24D0B333";
    // 단건결제 요청
    @GetMapping("/req")
    public void req(){
        log.info("GET /kakap/pay/req...");
        ...
        params.put("approval_url","https://localhost:8099/kakao/pay/success");  //결제 성공시 REDIRECT_URL
        params.put("fail_url","https://localhost:8099/kakao/pay/fail"); // 결제 실패시 REDIERCT_URL
        params.put("cancel_url","https://localhost:8099/kakao/pay/cancel"); // 결제 취소시 REDIERCT_URL
